...
<html lang="en">
    ...
    <body>
      	<section class="top">
          <div><a href="signup.php" style="color: white; text-decoration: none;">Team-Up now!</a></div>
        </section>
        <!--for guests start-->
        <section class="steps">
          <div class="boxes">
            <div>
              <p><span>#</span> Profiles</p>
            </div>
            <div>
        ...
        <section class="quotes">
          <div class="quotebox">
            <div class="quoteimage"><img src="./media/1.png"></div>
            <div class="quotetext">"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            tempor incididunt ut labore et dolore magna aliqua." - Your mamma</div>
          </div>
        </section>
        <!--for guests end-->
